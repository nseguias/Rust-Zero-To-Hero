...
pub fn instantiate(
    ...
    Ok(Response::new()
        // attributes are similar to HTTP headers -> provide metadata to the front end
    ...
    match poll {
        Some(mut poll) => {
            ...
            Ok(Response::new()
                ...
                .add_attribute("vote_updated", &poll.options[position].0))
        }
...
mod tests {
    ...
    use cosmwasm_std::{attr, from_binary}; // helper to construct an attribute e.g. ("action", "instantiate") // mock functions to mock an environment, message info, dependencies
    ...
    fn test_execute_create_poll_valid() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                attr("question", "What's your favourite Cosmos coin?")
            ]
        );
    }
